(() => {
  ...
  // svg-generating.js
  var initialViewBoxDimension = 32e3;
  var largestViewBoxDimension = 32e3;
  var byte = 1;
  var kilobyte = 1e3;
  var megabyte = 1e6;
  var gigabyte = 1e9;
  ...
  var createSizeBlock = (svg2, sideLength, fillStyle) => {
    svg2.rect(sideLength, sideLength).fill(fillStyle).radius(sideLength / 90);
  };
  ...
  var buildSVG = () => {
    const mySVG = SVG().addTo("#my-svg-container").size(600, 600).viewbox(0, 0, initialViewBoxDimension, initialViewBoxDimension).attr({ "style": "border: 1px solid black" });
